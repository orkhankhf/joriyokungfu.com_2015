...
<div class="container">
	<div class="row">
		...
		?>
		<!-- MIDDLE SIDE START -->
<div class=" video-galery-main col-lg-7 col-md-7 col-sm-10 col-xs-12" style="padding:0px;">
	<div class="video-galery">
		<?php
			include "DB/db.php";
			$page=$_GET["page"];
			$per_page=6;
			...
			$res=mysqli_query($conn,"SELECT * FROM videogalery order by tarix desc limit $page1 ,$per_page");
			while($row=mysqli_fetch_array($res)){	
			  echo "<div class='box-videos-main'><iframe class='box-videos' src='".$row['tmp']."' allowfullscreen></iframe>";
			  echo "<div class='tarix_info-div'><p class='videotarix'>".$row['tarix']."</p><p class='videoinfo'>".$row['videoinfo']."</p></div></div>";
			}
			$res1=mysqli_query($conn,"SELECT * FROM videogalery");
...
<ul class="photo-galery-pagination pagination pagination-md">
	...
	<li class="ilk_sehifeye" style='display:none;'><a href="videogalery.php">1</a><span>...</span></li>
	<?php   for($b=1;$b<=$a;$b++){    ?>
     	<script type="text/javascript">
	    	cem_seh.push(<?php echo $b; ?>);
	    </script>
    <?php   }  ?>
			<li class='smaller_page' id='1'><a class='smaller_page_a' href='videogalery.php?page=1'>1</a></li>
			<li class='smaller_page' id='2'><a class='smaller_page_a' href='videogalery.php?page=2'>2</a></li>
			<li class='current_pgg active' id='3'><a class='current_pgg_a' href='videogalery.php?page=3'>3</a></li>
			<li class='larger_page' id='4'><a class='larger_page_a' href='videogalery.php?page=4'>4</a></li>
			<li class='larger_page' id='5'><a class='larger_page_a' href='videogalery.php?page=5'>5</a></li>
			...
			<script type='text/javascript'>
							function sehife_yuklenende() {
								...
								document.getElementsByClassName('current_pgg_a')[0].href="videogalery.php?page="+pagenumber;
								...
								var b = document.getElementsByClassName('smaller_page_a')[1].href ='videogalery.php?page='+smaller_first;
								...
								var e = document.getElementsByClassName('smaller_page_a')[0].href ='videogalery.php?page='+smaller_second;
								...
								var h = document.getElementsByClassName('larger_page_a')[0].href ='videogalery.php?page='+larger_first;
								...
								var k = document.getElementsByClassName('larger_page_a')[1].href ='videogalery.php?page='+larger_second;
			...
			<li class="enson_sehife"><span>...</span><a href="videogalery.php?page=<?php echo$last_page;?>">Son(<?php echo$last_page;?>)</a></li>
</ul>
<script type="text/javascript">
	if(<?php echo $a ?> == ""){
