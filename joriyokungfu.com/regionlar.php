...
<div class="container">
  ...
  <div class="col-lg-7 col-md-7 col-sm-10 col-xs-12" style="padding:0px;">
      ...
      <h2 class="sehife_basliqlari">Azərbaycan Corİyo Kunq Fu Federasİyasının Regİonlardakı nümayəndəlİklərİ </h2>
          <?php
        include "DB/db.php";
        $select = "SELECT * FROM rehberlik WHERE bolme='regionlar' order by tarix desc";
